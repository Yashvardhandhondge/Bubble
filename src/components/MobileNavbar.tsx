...
const renderTokenSelector = () => {
  console.log('renderTokenSelector from mobile', currentView);
  ...
  return (
    <>
     ...
     null
      ...
      {/* SECTION FOR SECOND TOPBAR - DO NOT RENDER ANYTHING FOR "MENU" VIEW */}
      {currView === "chart" ? (
        ...
        /* DO NOT REnullNDER ANYTHING FOR MENU VIEW */
        null
      ) : null}
