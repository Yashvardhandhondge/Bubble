  ...
  useEffect(() => {
    const checkUserStatus = async () => {
      ...
      try {
        ...
        const registerResponse = await fetch('https://dimensions-titles-dc-specification.trycloudflare.com/api/auth/register', {
          method: 'POST',
          headers: {
        ...
        const subscriptionResponse = await fetch('https://dimensions-titles-dc-specification.trycloudflare.com/api/auth/check-subscription', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
